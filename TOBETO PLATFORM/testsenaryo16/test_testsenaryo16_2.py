...
class TestBosBirakilanYetkinlikKontrol(): 
    SECOND = 15
    ...
    def test_login(self):
        ...
        yetkinlik_button = WebDriverWait(self.driver, 5).until(EC.visibility_of_element_located((By.XPATH,"//div[@id='__next']/div/main/section/div/div/div[2]")))                                                                
