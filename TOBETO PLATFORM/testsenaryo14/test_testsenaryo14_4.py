...
class TestKurumadipozisyonsektoralanlarininnenfazlakarakterkontrol(): 
    SECOND = 15
    ...
    def test_login(self):
        ...
        kurumAdi.send_keys("OBEjcsnscajsjcnajcsnasjcnajsnasjnckasjcnajkcnajkcnj")
        sleep(1)
        
        pozisyon = WebDriverWait(self.driver,5).until(expected_conditions.visibility_of_element_located((By.NAME,"position",)))
        pozisyon.send_keys("YAzisdncjancjksnkcsdkckjcnjksdcnjksdcnkjsdckhdsbchsdcbnsd")
        sleep(1)
        ...
        sektör.send_keys("dcnjxnsascxdscjdsncjksdcnkjdscnjksdncjkdnjkdscnjkdscnjskdcnds")
        sleep(1)             
